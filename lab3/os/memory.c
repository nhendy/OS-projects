...
//
//----------------------------------------------------------------------
static int moveBetweenSpaces(PCB *pcb, unsigned char *s, unsigned char *u,
                             int n, int dir) {
...
//
//----------------------------------------------------------------------
uint32 MemoryPteToPage(uint32 pte) { return (pte & MEMORY_PTE_MASK); }
...
//
//----------------------------------------------------------------------
uint32 MemoryGetOperandAddress(PCB *pcb, uint32 instr) {
