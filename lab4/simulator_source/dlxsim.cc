...
//
//----------------------------------------------------------------------
inline void Cpu::GetRFields(uint32 inst, uint32 &src1, uint32 &src2,
                            uint32 &dst) {
...
inline void Cpu::GetIFields(uint32 inst, uint32 &src, uint32 &imm,
                            uint32 &dst) {
...
inline void Cpu::GetJFields(uint32 inst, uint32 &jaddr) {
...
inline void Cpu::SignExtend16(uint32 &v) {
  if (v & 0x8000) {
    v |= 0xffff0000;
  }
}

inline void Cpu::SignExtend8(uint32 &v) {
  if (v & 0x80) {
    v |= 0xffffff00;
  }
}
...
//
//----------------------------------------------------------------------
inline int Cpu::Jump(uint32 jmpDst) {
  if ((jmpDst & 0x3) == 0) {
...
//
//----------------------------------------------------------------------
static int InstAdd(uint32 inst, Cpu *cpu) {
...
static int InstSub(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  uint32 v1, v2, result;
...
static int InstAddu(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  uint32 v1, v2, result;
...
static int InstSubu(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  uint32 v1, v2, result;
...
//
//----------------------------------------------------------------------
static int InstAddi(uint32 inst, Cpu *cpu) {
  uint32 src1, dst, imm;
  uint32 v1, result;
...
static int InstSubi(uint32 inst, Cpu *cpu) {
  uint32 src1, dst, imm;
  uint32 v1, result;
...
static int InstAddui(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
  uint32 v1, result;
...
static int InstSubui(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
  uint32 v1, result;
...
static int InstAnd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstOr(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstXor(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstSll(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  uint32 v1, v2;
...
static int InstSra(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  uint32 v1, v2, result;
...
static int InstSrl(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  uint32 v1, v2;
...
//
//----------------------------------------------------------------------
static int InstAndi(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstOri(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstXori(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstSlli(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
  uint32 v1;
...
static int InstSrai(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
  uint32 v1, result;
...
static int InstSrli(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
  uint32 v1;
...
static int InstLhi(uint32 inst, Cpu *cpu) {
  uint32 src, dst, imm;
...
//
//----------------------------------------------------------------------
static int InstSeq(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstSne(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstSlt(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;

  cpu->GetRFields(inst, src1, src2, dst);
  cpu->PutIreg(dst,
               ((int)cpu->GetIreg(src1) < (int)cpu->GetIreg(src2)) ? 1 : 0);
  return (1);
}
static int InstSgt(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstSle(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstSge(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
//
//----------------------------------------------------------------------
static int InstSeqi(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstSnei(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstSlti(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstSgti(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstSlei(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
static int InstSgei(uint32 inst, Cpu *cpu) {
  uint32 src1, imm, dst;
...
//
//----------------------------------------------------------------------
static int InstLw(uint32 inst, Cpu *cpu) {
...
static int InstLh(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val;
...
static int InstLhu(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val;
  static int shiftcount[4] = {16, 16, 0, 0};
...
static int InstLb(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val;
...
static int InstLbu(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val;
  static int shiftcount[4] = {24, 16, 8, 0};
...
//
//----------------------------------------------------------------------
static int InstSh(uint32 inst, Cpu *cpu) {
...
static int InstSb(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val, kval, regval, shiftamt;
  static int shiftcount[4] = {24, 16, 8, 0};
...
static int InstSw(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val;
...
//
//----------------------------------------------------------------------
static int InstLf(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val;
...
static int InstLd(uint32 inst, Cpu *cpu) {
...
static int InstSf(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val;
...
static int InstSd(uint32 inst, Cpu *cpu) {
  uint32 addrReg, offset, dst, addr, val1, val2;
...
//
//----------------------------------------------------------------------
static int InstMovf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstMovd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstMovfp2i(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstMovi2fp(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
//
//----------------------------------------------------------------------
static int InstJmp(uint32 inst, Cpu *cpu) {
  uint32 joffset;
...
static int InstJr(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
static int InstJal(uint32 inst, Cpu *cpu) {
  uint32 joffset;
...
static int InstJalr(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
...
//
//----------------------------------------------------------------------
static int InstBeqz(uint32 inst, Cpu *cpu) {
...
static int InstBnez(uint32 inst, Cpu *cpu) {
  uint32 src, offset, dst;
...
static int InstBfpt(uint32 inst, Cpu *cpu) {
  uint32 src, offset, dst;
...
static int InstBfpf(uint32 inst, Cpu *cpu) {
  uint32 src, offset, dst;
...
//
//----------------------------------------------------------------------
static int InstMult(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstMultu(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstDiv(uint32 inst, Cpu *cpu) {
...
static int InstDivu(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst, denom;
  cpu->GetRFields(inst, src1, src2, dst);
  denom = cpu->GetFreg(src2);
  if (denom == 0) {
...
//	separately.
//----------------------------------------------------------------------
static int InstTrap(uint32 inst, Cpu *cpu) {
  uint32 trapVector;
...
//	interrupts on.
//----------------------------------------------------------------------
static int InstRfe(uint32 inst, Cpu *cpu) { return (cpu->DoRfe(inst)); }

int Cpu::DoRfe(uint32 inst) {
  uint32 iar;
  uint32 isr;
...
//
//----------------------------------------------------------------------
static int InstMovi2s(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  ...
  DBPRINTF('S', "Moving integer reg %d (0x%x) to special reg %d.\n", src1,
           cpu->GetIreg(src1), dst);
  cpu->PutSreg(dst, cpu->GetIreg(src1));
  return (1);
}

static int InstMovs2i(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  ...
  DBPRINTF('S', "Moving special reg %d (0x%x) to integer reg %d.\n", src1,
           cpu->GetSreg(src1), dst);
  cpu->PutIreg(dst, cpu->GetSreg(src1));
  return (1);
}

static int InstIllegal(uint32 inst, Cpu *cpu) {
  cpu->CauseException(DLX_EXC_ILLEGALINST);
  return (1);
}

static int InstNop(uint32, Cpu *cpu) { return (1); }
...
//
//----------------------------------------------------------------------
static int InstAddf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstSubf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  cpu->PutFregF(dst, cpu->GetFregF(src1) - cpu->GetFregF(src2));
  return (1);
...
static int InstMultf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  cpu->PutFregF(dst, cpu->GetFregF(src1) * cpu->GetFregF(src2));
  return (1);
...
static int InstDivf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  float denom;
  cpu->GetRFields(inst, src1, src2, dst);
...
//
//----------------------------------------------------------------------
static int InstEqf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstNef(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregF(src1) != cpu->GetFregF(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstLtf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregF(src1) < cpu->GetFregF(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstGtf(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregF(src1) > cpu->GetFregF(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstLef(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregF(src1) <= cpu->GetFregF(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstGef(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregF(src1) >= cpu->GetFregF(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
//
//----------------------------------------------------------------------
static int InstAddd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstSubd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  cpu->PutFregD(dst, cpu->GetFregD(src1) - cpu->GetFregD(src2));
  return (1);
...
static int InstMultd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  cpu->PutFregD(dst, cpu->GetFregD(src1) * cpu->GetFregD(src2));
  return (1);
...
static int InstDivd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  double denom;
  cpu->GetRFields(inst, src1, src2, dst);
...
//
//----------------------------------------------------------------------
static int InstEqd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstNed(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregD(src1) != cpu->GetFregD(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstLtd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregD(src1) < cpu->GetFregD(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstGtd(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregD(src1) > cpu->GetFregD(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstLed(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregD(src1) <= cpu->GetFregD(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
static int InstGed(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  if (cpu->GetFregD(src1) >= cpu->GetFregD(src2)) {
    cpu->SetStatusBit(DLX_STATUS_FPTRUE);
...
//
//----------------------------------------------------------------------
static int InstCvtf2d(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstCvtf2i(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstCvtd2f(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstCvtd2i(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstCvti2f(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
...
static int InstCvti2d(uint32 inst, Cpu *cpu) {
  uint32 src1, src2, dst;
  cpu->GetRFields(inst, src1, src2, dst);
  DBPRINTF('f', "Converting f%d (%08x) to DFP (%lf) in f%d\n", src1,
           cpu->GetFreg(src1), (double)cpu->GetFreg(src1), dst);
...
//
//----------------------------------------------------------------------
Instruction Cpu::fpInstrs[32] = {{0x00, DLX_FMT_RFMT, InstAddf},
...
//
//----------------------------------------------------------------------
inline int Cpu::VaddrToPaddr(uint32 vaddr, uint32 &paddr, uint32 op,
                             uint32 pteflags) {
  ...
  if (StatusBit(DLX_STATUS_PAGE_TABLE)) {
    ...
    if (UserMode() || ((op == DLX_MEM_READ) &&
      ...
      vaddr &= ~pagemask;
      if ((entrynum = (vaddr >> pt1pagebits)) >= GetSreg(DLX_SREG_PGTBL_SIZE)) {
...
// Zheng{
      ...
      if (pteflags & DLX_PTE_DIRTY) {
        SetMemory(pteaddr, paddr | (pteflags & DLX_PTE_DIRTY));
      }
#else
      //}Zheng
...
// Zheng
      ...
      paddr |= offsetinpage;
      DBPRINTF('m', "0x%x => 0x%x (=%08x) using base1=0x%x/%d, entry %d\n",
               vaddr | offsetinpage, paddr, Memory(paddr), pt1base, pt1pagebits,
               entrynum);
      return (1);
    } else {
      ...
      paddr = vaddr;
      if ((vaddr <= memSize) ||
          ((vaddr >= DLX_IO_BASE) && (vaddr <= (DLX_IO_BASE + DLX_IO_SIZE)))) {
        return (1);
      } else {
...
//
//----------------------------------------------------------------------
int Cpu::ReadWord(uint32 vaddr, uint32 &val, uint32 op) {
  uint32 paddr;
...
// Zheng{
#if USE_ROP
  if (!VaddrToPaddr(vaddr, paddr, DLX_MEM_WRITE, DLX_PTE_DIRTY)) {
#else
  //}Zheng
...
//
//----------------------------------------------------------------------
void Cpu::Read() { FileIo(DLX_FILE_READ); }

void Cpu::Write() { FileIo(DLX_FILE_WRITE); }
...
//
//----------------------------------------------------------------------
void Cpu::SetResult(uint32 r) { PutIreg(1, r); }
...
void Cpu::Printf() {
  ...
  printf(fmtaddr + (char *)memory, args[0], args[1], args[2], args[3], args[4],
...
int Cpu::ExecOne() {
  ...
  DBPRINTF('I', "Instr %06d: %08x : %08x (main=%02x, aux=%02x)\n",
           (int)instrsExecuted % 1000000, curInst, PC() - 4, curOp,
  ...
  switch (curOp) {
    ...
    case 0x01:  // FP operations
      funcCode =
          ((curInst >> DLX_FPU_FUNC_CODE_SHIFT) & DLX_FPU_FUNC_CODE_MASK);
...
//
//----------------------------------------------------------------------
void Cpu::SetTimer(uint32 usecs) { timerInterrupt = usElapsed + (double)usecs; }
