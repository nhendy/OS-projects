...
// Non-trap #defines:
#define PRINTF_MAX_FORMAT_LENGTH \
  256                      // Maximum length of any Printf format string
...
#define PRINTF_MAX_STRING_ARGS \
  5  // Maximum number of "%s"'s allowed in a format string
#define PRINTF_MAX_STRING_ARG_LENGTH \
  100  // Maximum length of any string printed with a "%s"
...
#define TRAP_ROP_ACCESS 0x8  // memory access violation trap
