...
static int reference[MEM_NUM_PAGES];
void PrintFreeMap() {
  int i;
...
void MemoryReferenceCount(int page) { reference[page] += 1; }
//---------------------------------------------------------------------
// MemoryROPHandler is to check for memory violations during copy on
// on write. Both parents and child need to be readonly.
//---------------------------------------------------------------------
