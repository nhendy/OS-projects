...
//
//----------------------------------------------------------------------
char *dstrcpy(char *to, const char *from) {
  char *tokeep = to;
  char last;
...
char *dstrncpy(char *to, const char *from, int n) {
  char *tokeep = to;
  char last;
...
const char *dstrstr(const char *buf, const char *pattern) {
...
//
//----------------------------------------------------------------------
const char *dmindex(const char *s, const char *match) {
  const char *c;
...
const char *dindex(const char *s, int c) {
  while (*s != '\0') {
    if (*s == c) {
      return (s);
    }
...
int dstrtol(char *c, char **newpos, int base) {
  int v = 0;
  int curdigit;
  int sign;
